...
export const AScanlines: React.FC = () => {
  return (
    <>
      <div className="fixed inset-0 pointer-events-none z-[9998n] bg-[repeating-linear-gradient(0deg,transparent_0px,transparent_3px,rgba(0,0,0,0.1)_3px,rgba(0,0,0,0.1)_4px)]" />
